...
class FavoritesAdapter
    (private val context: Context,
     ...
     private val onDeleteBtnClicked:(ProductModel)->Unit)
    : ListAdapter<ProductModel, FavoritesAdapter.ViewHolder>(MyDiffUtil()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.favorite_card,parent,false))
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.favBtn.setOnClickListener{
            onDeleteBtnClicked(currentProduct)
        }
    }
